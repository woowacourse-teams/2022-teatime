...
//    }
    ...
    void findCoachScheduleFailWrongYear() throws Exception {
        mockMvc.perform(get("/api/v2/coaches/1/schedules?year=2002&month=07"))
                .andDo(print())
                .andExpect(status().isBadRequest());
    }
    ...
    void findCoachScheduleFailWrongMonth() throws Exception {
        mockMvc.perform(get("/api/v2/coaches/1/schedules?year=2022&month=13"))
                .andDo(print())
                .andExpect(status().isBadRequest());
    }
...
//        mockMvc.perform(
//                        update("/api/v2/coaches/1/schedules", new ScheduleUpdateRequest(date, List.of(Date.findLastTime(date)))))
//                .andDo(print())
//                .andExpect(status().isBadRequest());
//    }
}
