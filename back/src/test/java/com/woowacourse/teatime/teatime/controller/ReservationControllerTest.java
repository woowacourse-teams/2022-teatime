...
//        mockMvc.perform(post("/api/v2/reservations", new ReservationReserveRequest(1L, 1L, 1L)))
//                .andDo(print())
...
//    }
    ...
    void reserveFailWrongCoachId() throws Exception {
        mockMvc.perform(post("/api/v2/reservations", new ReservationReserveRequest(1L, null, 1L)))
                .andDo(print())
    ...
    void reserveFailWrongScheduleId() throws Exception {
        mockMvc.perform(post("/api/v2/reservations", new ReservationReserveRequest(1L, 1L, null)))
                .andDo(print())
                .andExpect(status().isBadRequest());
    }
    ...
    void reserveFailWrongCrewId() throws Exception {
        mockMvc.perform(post("/api/v2/reservations", new ReservationReserveRequest(null, 1L, 1L)))
                .andDo(print())
                .andExpect(status().isBadRequest());
    }
