...
public class CrewAcceptanceTest extends AcceptanceTest {
    ...
    void findCrewReservations() {
        Long reservationId = ReservationAcceptanceTest.예약을_한다(new ReservationReserveRequest(crewId, coachId, scheduleId));
        ReservationAcceptanceTest.예약을_승인한다(reservationId, new ReservationApproveRequest(coachId, true));
        코치의_면담목록을_불러온다(coachId);
        ReservationAcceptanceTest.예약을_완료한다(reservationId);
